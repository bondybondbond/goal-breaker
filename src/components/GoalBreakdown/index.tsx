...
const GoalBreaker = () => {
  ...
  const handleGoalsImported = (importedGoals: any[]) => {
    ...
    setIsMenuOpen(false);
    // Canvas position is now managed by CanvasManager
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 overflow-hidden">
      ...
      {currentView === 'list' ? (
        ...
        <CanvasManager
          ...
          visibleGoals={getSortedGoals(getVisibleGoals())}
      ...
      <React.Fragment>
        ...
        {(goals.some(goal => goal.isEditing) || exportMessage || canvasState.spacePressed || canvasState.isPanning || selectedGoal) && (
          <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
            <div className="bg-white/95 backdrop-blur-sm border border-gray-300 shadow-lg rounded-lg px-4 py-2 text-sm text-gray-700 flex items-center gap-2">
              ...
              ) : (canvasState.spacePressed || canvasState.isPanning) ? (
                <>
                  <span>
